...
健康(6/10): 身体经常运动还行吧就是小肥了些，心理现在主要是焦虑迷茫，但也一直在学习心理学相关书籍，以及做正念冥想。`,
    ...
    },
    {
      ...
      content: [
        ...
        {
          subtitle: "创意联想",
          text: "- 户外/露营/旅游项目 + 体验/疗愈/修行\n- 探索自己，探索世界\n- 编程马拉松 + 旅行：找个风景好的地方举办编程马拉松\n- 2小时专心工作，其他时间专心玩"
        },
        {
          text: "工作是手段，优先保证事少探索自己的热爱，不然赚钱也不知道干嘛",
          emphasis: true
        }
      ],
      color: "bg-purple-500"
  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground">{lifeDesign.description}</p>
      </motion.div>

      <Tabs defaultValue="section-1" className="w-full">
        <TabsList className="grid grid-cols-3 h-auto">
          {lifeDesign.sections.map((section, index) => (
            <TabsTrigger
              key={`section-${index + 1}`}
